    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6 font-sans">
      ...
      >
        <div className="text-center mb-6 sm:mb-8 lg:mb-10">
          ...
          <p className="text-slate-500 mt-1 sm:mt-2 font-medium text-sm sm:text-base">Join the smart farming revolution</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <User className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-slate-400 group-focus-within:text-green-600 transition-colors" />
              <input
                type="text"
                required
                value={name}
          ...
          >
            {loading ? <Loader2 className="w-4 h-4 sm:w-6 sm:h-6 animate-spin" /> : "Sign Up"}
