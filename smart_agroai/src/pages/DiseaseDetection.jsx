        ...
        <div className="bg-white p-6 lg:p-10 rounded-[40px] shadow-sm border border-slate-100 flex flex-col items-center justify-center min-h-[500px] relative">
          {!previewUrl ? (
            <div 
              ...
              className="w-full h-full border-4 border-dashed border-slate-100 rounded-[32px] flex flex-col items-center justify-center cursor-pointer hover:border-green-200 hover:bg-green-50/30 transition-all group"
            >
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-1">Upload Leaf Image</h3>
